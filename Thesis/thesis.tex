...
The high-level process of ontology verbalization depicted from \hyperref[fig:verbaliser_architecture]{Figure~\ref*{fig:verbaliser_architecture}} consists of the following steps:

\paragraph{Transcoding from OWL to Prolog} Test.

\paragraph{Constructing a lexicon for atomic entities} Test.

\paragraph{Selecting the axioms relevant for describing each class} Test.

\paragraph{Aggregating axioms with a similar structure} Test.

\paragraph{Generating sentences from axioms} Test.
