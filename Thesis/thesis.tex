...
This Section begins with an introduction in the theory of dictionaries, lists several online dictionaries including the one we used in our approach as external source and ends with a detailed discussion on the architecture and workflow thereof. 
...
Lexicography is the science about~\enquote{the theory and practice of dictionaries, that is, dictionaries, encyclopedias, lexica, glossaries, vocabularies, terminological knowledge bases, and other information tools covering areas of knowledge and its corresponding language.}~\cite{fuertes2017}


%List several online dictionaries/lexiographic databases (e.g. Wordnik, Corpus of Contemporary American English, Wordnet, Oxford dictionary)
%Describe our appraoch of using Wordnik for ontology context enrichment
