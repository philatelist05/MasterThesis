...
%2.) Check the annotations (whether they are relevant in the respective domain or not)												PROGRESS
%3.) Check and manually add context descriptions (as described using the SKOS metadata set)											OPEN
%4.) Alter the implementation of "Embedded context" to use the SKOS metadata set instead of the OBO metadata set					OPEN
%5.) Run the Plugin to generate Figure Eight tasks (IMPORTANT: TAKE SCREENSHOTS FOR EACH OF THE CONTEXT ENRICHMENT METHODS)			OPEN
%6.) Also take screenshots when receiving the judgements from Figure Eight															OPEN
%7.) Download and collect the raw set of judgements																					OPEN
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% Data Visualisation %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%1.) Run experiments with context enrichment and without context enrichment															OPEN
	%2.1) Calculate overall Precision, Recall, F-measure and Agreement ratio														OPEN
	%2.2) Calculate metrics for each question (to show outliers)																	OPEN
	%2.3) Calculate metrics for each crowd worker (to show spammers)																OPEN
	%2.3) Draw RoC plots (https://en.wikipedia.org/wiki/Receiver_operating_characteristic)											OPEN
