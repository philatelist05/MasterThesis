...
% DONE     2.) Data --> What Ontologies can be used as a source for evaluation (O1, O2, ...)
% PROGRESS 3.) Setup --> How the actual test setup look like.
