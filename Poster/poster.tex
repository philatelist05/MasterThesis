			...
			\begin{column}{.49\linewidth}
				\begin{block}{Research Questions}
					    \begin{itemize}
					    	...
					    	\item \textsc{Context Enrichment of Crowdsourcing Tasks}
							
							Does the crowd perform better on context enriched Crowdsourcing tasks?
					    	\item \textsc{Context Enrichment Methods}
							
							What methods can be applied that generate Context?
					    	\item \textsc{Generalising the Applicability of the proposed Methods }
							
							To what extent is it possible to transfer the investigated methods to different datasets?
					    	\item \textsc{Comparative Evaluation of the proposed Methods }
