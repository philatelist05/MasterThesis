\begin{abstract}
	...
	% 2nd paragraph: Motivation for writing the thesis														DONE
	...
	However, all three approaches delivered results of high quality~(F-Measure above 80\%), indicating that adding Context to Crowdsourcing tasks
