...
% -) Rephrase Research Questions (RQ1 - RQ3) to results (RE1 - RE3)
...
% \begin{itemize}
% 	\item RQ1: Functional and non-functional requirements for building an extension of the uComp Protege plugin.
% 	\item RQ2: A detailed study of various options for enhancing crowdsourcing tasks with contextual information.
% 	\item RQ2, RQ3: A designed, implemented and evaluated extension of the uComp Protege plugin.
% 	\item RQ3: An in-depth evaluation on the performance of the proposed extension.
% 	\item RQ3: A reduction in costs and working time in crowdsourcing tasks while improving quality results from crowds.
% \end{itemize}
