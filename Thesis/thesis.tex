...
We also measured the average agreement ratio~(inter-rater agreement) in this dataset. \hyperref[table:bench_p_r_f]{Figure~\ref*{table:bench_p_r_f}} shows the distribution of the agreement ratio among all validated concepts. As we required 5 judgements for every concept, giving $5/0$, $4/1$ or $3/2$ levels of agreement which equates to an agreement ratio of $1.0$, $0.8$ and $0.6$ respectively. 
