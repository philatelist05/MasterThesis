		...
		\begin{columns}[t, onlytextwidth]
				...
				\begin{block}{Experimental Evaluation}
					\begin{minipage}[t][.25\textheight][c]{\textwidth}
						\begin{minipage}[t]{.45\textwidth}
							\small
							{\usebeamercolor[fg]{itemize item}{Experimental Setup}}\par
							Evaluation done on 3 Ontologies\\
						\end{minipage}
						\begin{minipage}[t]{.45\textwidth}
							\small
							{\usebeamercolor[fg]{itemize item}{Evaluation}}\par
			...
			\begin{column}{.49\linewidth}
				\begin{block}{Improvements through Context Enrichment}
					\begin{minipage}[t][.25\textheight][c]{\textwidth}
						%- Answer ) Does the crowd perform better on Context enriched Crowdsourcing tasks?
						
						%- Answer ) To what extent is it possible to transfer the investigated methods to different datasets?
						
						%- Answer ) Which of the proposed methods work best? What are potential shortcomings and why?
					\end{minipage}
				\end{block}
			\end{column}
		\end{columns}
