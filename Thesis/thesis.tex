...
The other approach in measuring the crowd's performance does not rely on reference values, instead the metric reflects the \textbf{Agreement Ratio} among the crowd workers. Therefore, the inter-rater agreement or concordance measures, to what extend consensus is reached by judges. 
