...
\chapter{Context Enrichment Methods}
%Context method 1:
	%Generate concept description based on neighbourhood
	%But cannot use OWLVerbalizer as that works on an ontology as a whole
	%Make sure you mention in the thesis that you tried to use this tool, but you could not, nevertheless you reused some of their rules
%Context method 2:
	%Get concept definition from wordnik
%Context method 3:
	%On medical ontology which already has some definitions; collaboratively edited;

\section{Neighboring Nodes}
