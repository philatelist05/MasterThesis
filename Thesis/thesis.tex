...
\paragraph{Searching in Electronic Dictionaries} A key factor in today's electronic dictionaries is its searching capabilities. In the next few paragraph we list problems that arise when searching for specific terms and strategies to overcome these issues.
...
\paragraph{WordNet} Test.

\paragraph{WordNik} Test.

\paragraph{Wiktionary} Test.
