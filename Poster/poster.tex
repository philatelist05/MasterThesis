					...
					\begin{minipage}[t][.25\textheight][c]{\textwidth}
						...
						\begin{minipage}[t]{0.93\textwidth}
							\begin{minipage}[t]{\textwidth}
								...
								The {\usebeamercolor[fg]{itemize item}{uComp Protege Plugin}}~\cite{wohlgenannt2016} allows the
				...
				\begin{minipage}[c]{\textwidth}
			    	...
			    	\begin{minipage}[t]{.3\linewidth}
						...
						\begin{itemize}
							...
							\item Terms of the {\usebeamercolor[fg]{itemize item}{Dublin Core Metadata}} were used to encode the metadata
