...
Based on existing efforts for ontology validation with the help of crowdsourcing~(see section~\ref{sec:ucomp_protege_plugin}) we formulate the following \textit{evaluation hypothesis}:
\begin{quotation}
