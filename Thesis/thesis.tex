...
We also measured the average agreement ratio~(inter-rater agreement) in this dataset. \hyperref[table:bench_p_r_f]{Figure~\ref*{table:bench_p_r_f}} shows the distribution of the agreement ratio among all validated concepts in this dataset. 
\begin{figure}
    \centering
