					...
					\begin{minipage}[t][.25\textheight][c]{\textwidth}
						...
						\begin{minipage}[t]{0.93\textwidth}
							...
							\begin{minipage}[t]{0.5\textwidth}
								...
								Extend plugin to enrich CS tasks with Context.
							\end{minipage}
					...
					\begin{minipage}[t][.25\textheight][c]{\textwidth}
						...
						\begin{minipage}[t]{0.93\textwidth}
							...
							\begin{itemize}
								...
								\justifying
								\setlength\itemsep{1cm}
								\item (Re-)evaluation the approaches with realistically large datasets to spot any bias towards specific characteristics of the validated ontology
