...
Distinguish between collection, analysis, and problem-solving (e.g. what the crowd can do).

Examples from below are taken from~\cite{simperl2013}.


\paragraph{Extraction} 
Introducing Wikidata to the Linked Data Web~\cite{erxleben2014}
...
\paragraph{Data Revision and Authoring}
Mechanical Protege\footnote{\url{http://people.aifb.kit.edu/yt2652/mechanicalProtege/}} - add documentation (create or correct structured information)

\paragraph{Data Linking}
TripleCheckMate: A Tool for Crowdsourcing the Quality Assessment of Linked Data~\cite{kontokostas2013} (users can detect interlinking problems and others)
